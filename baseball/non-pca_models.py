...
def models(response_col, predicts_col):
    ...
    # xgb_cv_model = xgb_rscv.fit(X_train_norm, y_train)

    # # Tuning results
    # print("Learning rate: ", xgb_cv_model.best_estimator_.get_params()["eta"])
    # print("Number of Trees: ", xgb_cv_model.best_estimator_.get_params()["n_estimators"])
    # print("Max Features at Split: ", xgb_cv_model.best_estimator_.get_params()["colsample_bytree"])
    # print("Max Depth: ", xgb_cv_model.best_estimator_.get_params()["max_depth"])
    # print("Alpha: ", xgb_cv_model.best_estimator_.get_params()["reg_alpha"])
    # print("Lamda: ", xgb_cv_model.best_estimator_.get_params()["reg_lambda"])
    # print("Subsample: ", xgb_cv_model.best_estimator_.get_params()["subsample"])
...
def perf_table(model_names, predictions, y_test):
    ...
    with open("./results/non-pca_models/pca_performance_table", "w") as html_open:
